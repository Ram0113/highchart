...
*/
(function (v) {
    "object" === typeof module && module.exports ? (v["default"] = v, module.exports = v) : "function" === typeof define && define.amd ? define("highcharts/modules/accessibility", ["highcharts"], function (r) {
        v(r);
        v.Highcharts = r;
        return v
    ...
    function r(a, f, q, l) {
        a.hasOwnProperty(f) || (a[f] = l.apply(null, q))
    }

    var a = v ? v._modules : {};
    r(a, "modules/accessibility/utils/htmlUtilities.js", [a["parts/Utilities.js"], a["parts/Globals.js"]], function (a, f) {
        function h(a) {
            return a.replace(/&/g,
                "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;")
        }

        var l = a.merge, n = f.win, e = n.document;
        return {
            addClass: function (a, e) {
                a.classList ? a.classList.add(e) : 0 > a.className.indexOf(e) && (a.className += e)
            }, escapeStringForHTML: h, getElement: function (a) {
                return e.getElementById(a)
            }, getFakeMouseEvent: function (a) {
                if ("function" === typeof n.MouseEvent) return new n.MouseEvent(a);
                if (e.createEvent) {
                    var t = e.createEvent("MouseEvent");
                    if (t.initMouseEvent) return t.initMouseEvent(a,
                ...
                Object.keys(e).forEach(function (k) {
                    var d = e[k];
                    null === d ? a.removeAttribute(k) : (d = h("" + d), a.setAttribute(k, d))
                })
    ...
    r(a, "modules/accessibility/utils/chartUtilities.js", [a["modules/accessibility/utils/htmlUtilities.js"], a["parts/Utilities.js"]], function (a, f) {
        ...
        function l(a) {
            var d =
                h(a);
            return d && d.parentNode || a.graph && a.graph.element || a.group && a.group.element
        }

        function n(a, d) {
            d.setAttribute("aria-hidden", !1);
            d !== a.renderTo && d.parentNode && (Array.prototype.forEach.call(d.parentNode.childNodes, function (c) {
                c.hasAttribute("aria-hidden") || c.setAttribute("aria-hidden", !0)
            }), n(a, d.parentNode))
        }

        var e = a.stripHTMLTagsFromString, t = f.defined, p = f.find;
        return {
            getChartTitle: function (a) {
                return e(a.options.title.text || a.langFormat("accessibility.defaultChartTitle", {chart: a}))
            ...
            }, getPointFromXY: function (a, d, c) {
                for (var b = a.length, g; b--;) if (g = p(a[b].points || [], function (b) {
                    return b.x === d && b.y === c
                })) return g
            }, getSeriesFirstPointElement: h, getSeriesFromName: function (a, d) {
                return d ? (a.series || []).filter(function (c) {
                    return c.name === d
                }) : a.series
            }, getSeriesA11yElement: l, unhideChartElementFromAT: n,
            hideSeriesFromAT: function (a) {
                (a = l(a)) && a.setAttribute("aria-hidden", !0)
            }, scrollToPoint: function (a) {
                var d = a.series.xAxis, c = a.series.yAxis, b = (null === d || void 0 === d ? 0 : d.scrollbar) ? d : c;
                if ((d = null === b || void 0 === b ? void 0 : b.scrollbar) && t(d.to) && t(d.from)) {
                    c = d.to - d.from;
                    if (t(b.dataMin) && t(b.dataMax)) {
                        var g = b.toPixels(b.dataMin), m = b.toPixels(b.dataMax);
                        a = (b.toPixels(a["xAxis" === b.coll ? "x" : "y"] || 0) - g) / (m - g)
                    } else a = 0;
                    d.updatePosition(a - c / 2, a + c / 2);
                    v.fireEvent(d, "changed", {
    ...
    r(a, "modules/accessibility/KeyboardNavigationHandler.js", [a["parts/Utilities.js"]], function (a) {
        ...
        h.prototype = {
            run: function (a) {
                var h = a.which || a.keyCode, e = this.response.noHandler, t = q(this.keyCodeMap, function (a) {
                    return -1 < a[0].indexOf(h)
                });
                t ? e = t[1].call(this, h, a) : 9 === h && (e = this.response[a.shiftKey ?
                    "prev" : "next"]);
                return e
            }
        };
    ...
    r(a, "modules/accessibility/utils/EventProvider.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, f) {
        var h = f.addEvent;
        f = f.extend;
        var l = function () {
            this.eventRemovers = []
    ...
    r(a, "modules/accessibility/utils/DOMElementProvider.js", [a["parts/Globals.js"],
        a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, f, q) {
        var h = a.win.document;
        a = f.extend;
        var n = q.removeElement;
        q = function () {
            this.elements = []
        };
        a(q.prototype, {
            createElement: function () {
                var a = h.createElement.apply(h, arguments);
    ...
    r(a, "modules/accessibility/AccessibilityComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"],
        ...
        var p = a.win, k = p.document;
        a = f.extend;
        var d = f.fireEvent, c = f.merge, b = q.removeElement, g = q.getFakeMouseEvent, m = l.unhideChartElementFromAT;
        h.prototype = {
            initBase: function (b) {
                this.chart = b;
            ...
            addEvent: function () {
                ...
                var a = c.type;
                k.createEvent && (b.dispatchEvent || b.fireEvent) ? b.dispatchEvent ? b.dispatchEvent(c) : b.fireEvent(a, c) : d(b, a, c)
                ...
                return b
            }, createProxyButton: function (b, a, g, d, z) {
                var x = b.element, u = this.createElement("button"),
                    e = c({"aria-label": x.getAttribute("aria-label")}, g);
                b = this.getElementPosition(d || b);
                Object.keys(e).forEach(function (b) {
                    null !== e[b] && u.setAttribute(b, e[b])
                });
                u.className = "highcharts-a11y-proxy-button";
                z && this.addEvent(u, "click", z);
                this.setProxyButtonStyle(u, b);
                this.proxyMouseEventsForButton(x, u);
                a.appendChild(u);
                e["aria-hidden"] || m(this.chart, u);
                return u
            }, getElementPosition: function (b) {
                var c = b.element;
                return (b =
                    this.chart.renderTo) && c && c.getBoundingClientRect ? (c = c.getBoundingClientRect(), b = b.getBoundingClientRect(), {
                    x: c.left - b.left,
                    y: c.top - b.top,
                ...
                var a = this;
                "click touchstart touchend touchcancel touchmove mouseover mouseenter mouseleave mouseout".split(" ").forEach(function (g) {
                    a.addEvent(c, g, function (c) {
                        var g = a.cloneMouseEvent(c);
                        b && a.fireEventOnWrappedOrUnwrappedElement(b, g);
                        c.stopPropagation();
                        c.preventDefault()
                    })
                })
                ...
                if (k.createEvent) {
                    ...
                    if (c.initMouseEvent) return c.initMouseEvent(b.type, b.bubbles, b.cancelable, b.view || p, b.detail, b.screenX, b.screenY, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, b.button, b.relatedTarget), c
                }
                return g(b.type)
    ...
    r(a, "modules/accessibility/KeyboardNavigation.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/EventProvider.js"]], function (a, f, q, l) {
        ...
        var e = a.win, t = e.document, p = f.addEvent, k = f.fireEvent, d = q.getElement;
        p(t, "keydown", function (c) {
            27 === (c.which || c.keyCode) && a.charts && a.charts.forEach(function (b) {
        ...
        h.prototype = {
            init: function (c, b) {
                var a = this, d = this.eventProvider = new l;
                this.chart = c;
                this.components = b;
                this.modules = [];
                this.currentModuleIx = 0;
                d.addEvent(c.renderTo, "keydown", function (b) {
                    return a.onKeydown(b)
                });
                d.addEvent(c.container, "focus", function (b) {
                    return a.onFocus(b)
                });
                d.addEvent(t, "mouseup", function () {
                    return a.onMouseUp()
                });
                d.addEvent(c.renderTo,
                    "mousedown", function () {
                        a.isClickingChart = !0
                    });
                d.addEvent(c.renderTo, "mouseover", function () {
                    a.pointerIsOverChart = !0
                });
                d.addEvent(c.renderTo, "mouseout", function () {
                ...
                b && b.enabled && c && c.length ? (this.modules = c.reduce(function (b, c) {
                ...
                this.isClickingChart || c || (null === (b = this.modules[0]) || void 0 === b ? void 0 : b.init(1))
            }, onMouseUp: function () {
                delete this.isClickingChart;
                if (!this.keyboardReset && !this.pointerIsOverChart) {
                    var c = this.chart, b = this.modules && this.modules[this.currentModuleIx || 0];
                ...
                c = c || e.event;
                var b, a = this.modules && this.modules.length && this.modules[this.currentModuleIx];
                this.keyboardReset = !1;
                if (a) {
                    var d = a.run(c);
                    d === a.response.success ? b = !0 : d === a.response.prev ? b = this.prev() : d === a.response.next && (b = this.next());
                    b && (c.preventDefault(), c.stopPropagation())
                }
            }, prev: function () {
                return this.move(-1)
            }, next: function () {
                ...
                if (b = this.modules && this.modules[this.currentModuleIx]) {
                    if (b.validate && !b.validate()) return this.move(c);
                    if (b.init) return b.init(c), !0
                }
                this.currentModuleIx = 0;
                0 < c ? (this.exiting = !0, this.exitAnchor.focus()) : this.chart.container.focus();
                return !1
            }, updateExitAnchor: function () {
                var c = d("highcharts-end-of-chart-marker-" + this.chart.index);
                this.removeExitAnchor();
                c ? (this.makeElementAnExitAnchor(c), this.exitAnchor =
                    c) : this.createExitAnchor()
            }, updateContainerTabindex: function () {
                var c = this.chart.options.accessibility;
                c = c && c.keyboardNavigation;
                c = !(c && !1 === c.enabled);
                var b = this.chart.container, a = b.getAttribute("tabIndex");
                c && !a ? b.setAttribute("tabindex", "0") : c || "0" !== a || b.removeAttribute("tabindex")
                ...
                var c =
                    this.chart, b = this.exitAnchor = t.createElement("div");
                c.renderTo.appendChild(b);
                ...
                this.eventProvider.addEvent(c, "focus", function (c) {
                    c = c || e.event;
                    c.relatedTarget && b.container.contains(c.relatedTarget) || a.exiting ? a.exiting = !1 : (b.renderTo.focus(), c.preventDefault(),
    ...
    r(a, "modules/accessibility/components/LegendComponent.js", [a["parts/Globals.js"], a["parts/Legend.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"],
        ...
        var h = q.addEvent, p = q.extend, k = q.fireEvent, d = e.stripHTMLTagsFromString, c = e.removeElement;
        a.Chart.prototype.highlightLegendItem = function (b) {
            var c = this.legend.allItems, a = this.highlightedLegendItemIx;
            if (c[b]) {
                c[a] && k(c[a].legendGroup.element, "mouseout");
                a = this.legend;
                var d = a.allItems[b].pageIx, e = a.currentPage;
                "undefined" !== typeof d && d + 1 !== e && a.scroll(1 + d - e);
                this.setFocusToElement(c[b].legendItem,
                    c[b].a11yProxyElement);
                k(c[b].legendGroup.element, "mouseover");
                return !0
            }
            return !1
        };
        h(f, "afterColorizeItem", function (b) {
            var c = b.item;
        ...
        p(a.prototype, {
            init: function () {
                ...
                this.addEvent(f, "afterScroll", function () {
                    this.chart === b.chart && b.updateProxies()
                })
            }, updateLegendItemProxyVisibility: function () {
                var b = this.chart.legend, c = b.currentPage ||
                    1, a = b.clipHeight || 0;
                (b.allItems || []).forEach(function (d) {
                    var g = d.pageIx || 0, m = d._legendItemPos ? d._legendItemPos[1] : 0,
                        u = d.legendItem ? Math.round(d.legendItem.getBBox().height) : 0;
                    g = m + u - b.pages[g] > a || g !== c - 1;
                    d.a11yProxyElement && (d.a11yProxyElement.style.visibility = g ? "hidden" : "visible")
                })
            }, onChartRender: function () {
                this.legendProxyButtonClicked ? delete this.legendProxyButtonClicked : this.updateProxies()
            }, updateProxies: function () {
                c(this.legendProxyGroup);
                var b = this.chart, a = b.legend && b.legend.allItems, d = b.options.legend.accessibility ||
                    {};
                ...
                var c = this, a = this.chart.langFormat("accessibility.legend.legendItem", {
                    chart: this.chart,
                    itemName: d(b.name)
                });
                b.a11yProxyElement = this.createProxyButton(b.legendItem, this.legendProxyGroup, {
                    ...
                    c.legendProxyButtonClicked = !0
                })
            }, getKeyboardNavigation: function () {
                var b = this.keyCodes, c = this;
                return new n(this.chart, {
                    keyCodeMap: [[[b.left,
                        b.right, b.up, b.down], function (b) {
                ...
                var a = this.keyCodes, d = b.response, g = this.chart, e = g.options.accessibility,
                    u = g.legend.allItems.length;
                c = c === a.left || c === a.up ? -1 : 1;
                return g.highlightLegendItem(this.highlightedLegendItemIx + c) ? (this.highlightedLegendItemIx += c, d.success) : 1 < u &&
                ...
                c && c.a11yProxyElement && k(c.a11yProxyElement, "click");
                return b.response.success
            }, shouldHaveLegendNavigation: function () {
                var b = this.chart, c = b.colorAxis && b.colorAxis.length,
                ...
                var c =
                    this.chart, a = c.legend.allItems.length - 1;
                b = 0 < b ? 0 : a;
    ...
    r(a, "modules/accessibility/components/MenuComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, f, q, l, n, e) {
        ...
        f = f.extend;
        var p = n.unhideChartElementFromAT, k = e.removeElement, d = e.getFakeMouseEvent;
        a.Chart.prototype.showExportMenu = function () {
            var c = h(this);
            if (c && (c = c.element, c.onclick)) c.onclick(d("click"))
        };
        a.Chart.prototype.hideExportMenu = function () {
            var c = this.exportDivElements;
            c && this.exportContextMenu && (c.forEach(function (b) {
        ...
        a.Chart.prototype.highlightExportItem =
            function (c) {
                ...
                if (b && "LI" === b.tagName && (!b.children || !b.children.length)) {
                    var m = !!(this.renderTo.getElementsByTagName("g")[0] || {}).focus;
                    b.focus && m && b.focus();
                    if (a && a.onmouseout) a.onmouseout(d("mouseout"));
                    if (b.onmouseover) b.onmouseover(d("mouseover"));
        ...
        a.Chart.prototype.highlightLastExportItem = function () {
            var c;
            if (this.exportDivElements) for (c =
        ...
        f(a.prototype, {
            init: function () {
                ...
                var c = this.chart,
                    b = c.exportContextMenu;
                b && (this.addAccessibleContextMenuAttribs(), p(c, b));
                this.isExportMenuShown = !0;
                this.setExportButtonExpandedState("true")
            }, setExportButtonExpandedState: function (c) {
                var b = this.exportButtonProxy;
                b && b.setAttribute("aria-expanded", c)
            }, onChartRender: function () {
                var c = this.chart, b = c.options.accessibility;
                k(this.exportProxyGroup);
                var a = c.options.exporting, d = h(c);
                a && !1 !== a.enabled && a.accessibility && a.accessibility.enabled && d && d.element && (this.exportProxyGroup = this.addProxyGroup("all" ===
                b.landmarkVerbosity ? {
                    "aria-label": c.langFormat("accessibility.exporting.exportRegionLabel", {chart: c}),
                    role: "region"
                } : {}), b = h(this.chart), this.exportButtonProxy = this.createProxyButton(b, this.exportProxyGroup, {
                    "aria-label": c.langFormat("accessibility.exporting.menuButtonLabel", {chart: c}),
                    "aria-expanded": "false"
                }))
            }, addAccessibleContextMenuAttribs: function () {
                var c = this.chart, b = c.exportDivElements;
                ...
                var c = this.keyCodes, b = this.chart, a = this;
                return new l(b, {
                    keyCodeMap: [[[c.left, c.up], function () {
                        return a.onKbdPrevious(this)
                    }], [[c.right, c.down], function () {
                    ...
                    validate: function () {
                        ...
                        var c = a.exportButtonProxy, d = b.exportingGroup;
                ...
                c = c.response;
                for (var d = b.highlightedExportItemIx || 0; d--;) if (b.highlightExportItem(d)) return c.success;
                return a.keyboardNavigation.wrapAround ? (b.highlightLastExportItem(), c.success) :
                    c.prev
            }, onKbdNext: function (c) {
                var b = this.chart, a = b.options.accessibility;
                c = c.response;
                for (var d = (b.highlightedExportItemIx || 0) + 1; d < b.exportDivElements.length; ++d) if (b.highlightExportItem(d)) return c.success;
                return a.keyboardNavigation.wrapAround ? (b.highlightExportItem(0), c.success) : c.next
            }, onKbdClick: function (c) {
                var b = this.chart, a = b.exportDivElements[b.highlightedExportItemIx], d = h(b).element;
                this.isExportMenuShown ? this.fakeClickEvent(a) : (this.fakeClickEvent(d), b.highlightExportItem(0));
    ...
    r(a, "modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js", [a["parts/Globals.js"], a["parts/Point.js"], a["parts/Utilities.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/EventProvider.js"], a["modules/accessibility/utils/chartUtilities.js"]], function (a, f, q, l, n, e) {
        function h(b) {
            var c = b.index, a = b.series.points, d = a.length;
            if (a[c] !== b) for (; d--;) {
                if (a[d] === b) return d
            } else return c
        }
        ...
        function p(b) {
            var c = b.chart.options.accessibility.keyboardNavigation.seriesNavigation,
                a = b.options.accessibility || {}, d = a.keyboardNavigation;
        ...
        function k(b) {
            ...
            return b.isNull && c.keyboardNavigation.seriesNavigation.skipNullPoints || !1 === b.visible || p(b.series)
        }

        function d(b, c, a, d) {
            var g = Infinity, w = c.points.length, e = function (b) {
                return !(m(b.plotX) && m(b.plotY))
            };
            if (!e(b)) {
                for (; w--;) {
                    var u =
                        c.points[w];
                    if (!e(u) && (u = (b.plotX - u.plotX) * (b.plotX - u.plotX) * (a || 1) + (b.plotY - u.plotY) * (b.plotY - u.plotY) * (d || 1), u < g)) {
                        g = u;
                        var z = w
                    }
                }
        ...
        var g = q.extend, m = q.defined, x = e.getPointFromXY, A = e.getSeriesFromName, B = e.scrollToPoint;
        ...
        a.Chart.prototype.highlightAdjacentPoint = function (b) {
            var c = this.series, a = this.highlightedPoint, d = a && h(a) || 0, m = a && a.series.points,
                g = this.series && this.series[this.series.length - 1];
            g = g && g.points && g.points[g.points.length - 1];
            if (!c[0] ||
                !c[0].points) return !1;
            if (a) {
                if (c = c[a.series.index + (b ? 1 : -1)], d = m[d + (b ? 1 : -1)], !d && c && (d = c.points[b ? 0 : c.points.length - 1]), !d) return !1
            } else d = b ? c[0].points[0] : g;
            return k(d) ? (c = d.series, p(c) ? this.highlightedPoint = b ? c.points[c.points.length - 1] : c.points[0] : this.highlightedPoint = d, this.highlightAdjacentPoint(b)) : d.highlight()
        };
        a.Series.prototype.highlightFirstValidPoint = function () {
            var b = this.chart.highlightedPoint, c = (b && b.series) === this ? h(b) : 0;
            b = this.points;
            var a = b.length;
            if (b && a) {
        ...
        a.Chart.prototype.highlightAdjacentSeries = function (b) {
            ...
            var g = (c = this.series && this.series[this.series.length - 1]) && c.points && c.points[c.points.length - 1];
            if (!this.highlightedPoint) return c = b ? this.series && this.series[0] : c, (g = b ? c && c.points && c.points[0] : g) ? g.highlight() : !1;
            c = this.series[a.series.index + (b ? -1 : 1)];
            if (!c) return !1;
            g = d(a, c, 4);
            if (!g) return !1;
            if (p(c)) return g.highlight(), b = this.highlightAdjacentSeries(b), b ?
                b : (a.highlight(), !1);
            g.highlight();
            return g.series.highlightFirstValidPoint()
        };
        a.Chart.prototype.highlightAdjacentPointVertical = function (b) {
            var c = this.highlightedPoint, a = Infinity, d;
            if (!m(c.plotX) || !m(c.plotY)) return !1;
            this.series.forEach(function (g) {
                p(g) || g.points.forEach(function (w) {
                    if (m(w.plotY) && m(w.plotX) && w !== c) {
                        var e = w.plotY - c.plotY, x = Math.abs(w.plotX - c.plotX);
                        x = Math.abs(e) * Math.abs(e) + x * x * 4;
                        g.yAxis && g.yAxis.reversed && (e *= -1);
                        !(0 >= e && b || 0 <= e && !b || 5 > x || k(w)) && x < a && (a = x, d = w)
                    }
                })
            });
            return d ? d.highlight() :
                !1
        };
        g(b.prototype, {
            init: function () {
                var b = this, d = this.chart, g = this.eventProvider = new n;
                g.addEvent(a.Series, "destroy", function () {
                    return b.onSeriesDestroy(this)
                });
                g.addEvent(d, "afterDrilldown", function () {
                    c(this);
                    this.focusElement && this.focusElement.removeFocusBorder()
                });
                g.addEvent(d, "drilldown", function (c) {
                    c = c.point;
                    var a = c.series;
                    b.lastDrilledDownPoint = {x: c.x, y: c.y, seriesName: a ? a.name : ""}
                });
                g.addEvent(d, "drillupall", function () {
                    setTimeout(function () {
                        b.onDrillupAll()
                    }, 10)
                })
                ...
                var b =
                    this.lastDrilledDownPoint, c = this.chart, a = b && A(c, b.seriesName), d;
                b && a && m(b.x) && m(b.y) && (d = x(a, b.x, b.y));
                c.container && c.container.focus();
                d && d.highlight && d.highlight();
                c.focusElement && c.focusElement.removeFocusBorder()
            }, getKeyboardNavigationHandler: function () {
                var b = this, c = this.keyCodes, a = this.chart, d = a.inverted;
                return new l(a, {
                ...
                var a = this.chart, d = this.keyCodes;
                c = c === d.down || c === d.right;
                d = a.options.accessibility.keyboardNavigation.seriesNavigation;
                if (d.mode && "serialize" ===
                    d.mode) return this.attemptHighlightAdjacentPoint(b, c);
                ...
                return b.response.success
            }, onHandlerInit: function (b, a) {
                var d = this.chart;
                if (0 < a) c(d); else {
                    a = d.series.length;
                    for (var g; a-- && !(d.highlightedPoint = d.series[a].points[d.series[a].points.length - 1], g = d.series[a].highlightFirstValidPoint());) ;
                }
                return b.response.success
                ...
                var a = this.chart, d = a.options.accessibility.keyboardNavigation.wrapAround;
                return a.highlightAdjacentPoint(c) ? b.response.success : d ? b.init(c ? 1 : -1) : b.response[c ? "next" : "prev"]
            }, onSeriesDestroy: function (b) {
                var c = this.chart;
                c.highlightedPoint && c.highlightedPoint.series === b && (delete c.highlightedPoint,
                c.focusElement && c.focusElement.removeFocusBorder())
            }, destroy: function () {
                this.eventProvider.removeAddedEvents()
            }
    ...
    r(a, "modules/accessibility/components/AnnotationsA11y.js", [a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, f) {
        function h(a) {
            return (a.annotations || []).reduce(function (c, b) {
                var a;
                !1 !== (null === (a = b.options) || void 0 === a ? void 0 : a.visible) && (c = c.concat(b.labels));
                return c
            }, [])
        }
        ...
        function l(a) {
            ...
            c ? void 0 : c.accessibility) || void 0 === b ? void 0 : b.description;
            return e ? e : (null === (m = null === (d = a.graphic) || void 0 === d ? void 0 : d.text) || void 0 === m ? void 0 : m.textStr) || ""
        }

        function n(a) {
            var c, b,
                d = null === (b = null === (c = a.options) || void 0 === c ? void 0 : c.accessibility) || void 0 === b ? void 0 : b.description;
            if (d) return d;
            c = a.chart;
            b = l(a);
            ...
            var m = d.length;
            a = "accessibility.screenReaderSection.annotations.description" + (1 < m ? "MultiplePoints" : m ? "SinglePoint" : "NoPoints");
            b = {annotationText: b, numPoints: m, annotationPoint: d[0], additionalAnnotationPoints: d.slice(1)};
            return c.langFormat(a,
                b)
        }

        function e(a) {
            return h(a).map(function (c) {
                return (c = p(k(n(c)))) ? "<li>" + c + "</li>" : ""
            })
        }

        var t = a.inArray, p = f.escapeStringForHTML, k = f.stripHTMLTagsFromString;
        return {
            getAnnotationsInfoHTML: function (a) {
                var c = a.annotations;
                return c && c.length ? "<ul>" + e(a).join(" ") + "</ul>" : ""
            }, getAnnotationLabelDescription: n, getAnnotationListItems: e, getPointAnnotationTexts: function (a) {
                var c = h(a.series.chart).filter(function (b) {
                    return -1 < t(a, b.points)
                });
                return c.length ? c.map(function (b) {
                    return "" + l(b)
                }) : []
            }
        }
    ...
    r(a, "modules/accessibility/components/SeriesComponent/SeriesDescriber.js",
        [a["parts/Utilities.js"], a["modules/accessibility/components/AnnotationsA11y.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["parts/Tooltip.js"]], function (a, f, q, l, n) {
            function e(b) {
                var c = b.index;
                return b.series && b.series.data && F(c) ? C(b.series.data, function (b) {
            ...
            function d(b, c) {
                ...
                a = a.options.lang;
                return w(c) ? D(c, d.valueDecimals || b.valueDecimals || -1,
                    a.decimalPoint, a.accessibility.thousandsSep || a.thousandsSep) : c
            }

            function c(b) {
                var c = (b.options.accessibility || {}).description;
                return c && b.chart.langFormat("accessibility.series.description", {description: c, series: b}) || ""
            }

            function b(b, c) {
                return b.chart.langFormat("accessibility.series." + c + "Description", {name: J(b[c]), series: b})
            }

            function g(b) {
                var c = b.series, a = c.chart, d = a.options.accessibility.point || {};
                if (c.xAxis && c.xAxis.dateTime) return c = n.prototype.getXDateFormat.call({
            ...
            function m(b) {
                var c = g(b),
                    a = (b.series.xAxis || {}).categories && F(b.category) && ("" + b.category).replace("<br/>", " "),
                    d = b.id && 0 > b.id.indexOf("highcharts-"), m = "x, " + b.x;
                return b.name || c || a || (d ? b.id : m)
            }
            ...
            function A(b) {
                var c =
                        b.series, a = c.chart.options.accessibility.point || {}, g = c.tooltipOptions || {},
                    m = a.valuePrefix || g.valuePrefix || "";
                a = a.valueSuffix || g.valueSuffix || "";
                g = d(b, b["undefined" !== typeof b.value ? "value" : "y"]);
                return b.isNull ? c.chart.langFormat("accessibility.series.nullPointValue", {point: b}) : c.pointArrayMap ? x(b, m, a) : m + g + a
            }

            function B(b) {
                var c = b.series, a = c.chart, d = a.options.accessibility.point.valueDescriptionFormat,
                    g = (c = y(c.xAxis && c.xAxis.options.accessibility && c.xAxis.options.accessibility.enabled, !a.angular)) ?
                        m(b) : "";
                b = {
                    point: b,
                    index: F(b.index) ? b.index + 1 : "",
                    xDescription: g,
                    value: A(b),
                    separator: c ? ", " : ""
                };
            ...
            function u(b) {
                var c = b.series, a = c.chart, d = B(b),
                    g = b.options && b.options.accessibility && b.options.accessibility.description;
                g = g ? " " + g : "";
                c = 1 < a.series.length && c.name ? " " + c.name + "." : "";
                a = b.series.chart;
                var m = I(b), e = {point: b, annotations: m};
                a = m.length ? a.langFormat("accessibility.series.pointAnnotationsDescription", e) : "";
            ...
            function r(b) {
                ...
                (c || a) && b.points.forEach(function (b) {
                    ...
                    if (!(a = b.graphic && b.graphic.element) && (a = b.series && b.series.is("sunburst"), a = b.isNull && !a)) {
                        var d = b.series, g = e(b);
                        d = (a = g && g.graphic) ? a.parentGroup : d.graph || d.group;
                        g = g ? {x: y(b.plotX, g.plotX, 0), y: y(b.plotY, g.plotY, 0)} : {
                            x: y(b.plotX, 0),
                            y: y(b.plotY, 0)
                        };
                        g = b.series.chart.renderer.rect(g.x, g.y, 1, 1);
                        g.attr({
            ...
            function v(a) {
                var d = a.chart,
                    g = d.types || [], m = c(a), e = function (b) {
                        return d[b] && 1 < d[b].length && a[b]
                    }, w = b(a, "xAxis"), k = b(a, "yAxis"), y = {
                        name: a.name || "",
                        ix: a.index + 1,
                ...
                g = 1 < g.length ? "Combination" : "";
                return (d.langFormat("accessibility.series.summary." + a.type + g, y) || d.langFormat("accessibility.series.summary.default" + g, y)) + (m ? " " + m : "") + (e("yAxis") ? " " + k : "") + (e("xAxis") ? " " + w : "")
            }

            var C = a.find, E = a.format, w = a.isNumber, D = a.numberFormat, y = a.pick, F = a.defined,
                I = f.getPointAnnotationTexts,
                G = q.escapeStringForHTML, K = q.reverseChildNodes, H = q.stripHTMLTagsFromString,
                J = l.getAxisDescription, L = l.getSeriesFirstPointElement, M = l.getSeriesA11yElement,
                N = l.unhideChartElementFromAT;
            return {
                describeSeries: function (b) {
                    var c = b.chart, a = L(b), d = M(b), g = c.is3d && c.is3d();
                    if (d) {
                        d.lastChild !== a || g || K(d);
                        r(b);
                        N(c, d);
                        ...
                        c = g.options.chart || {};
                        a = 1 < g.series.length;
                        g = g.options.accessibility.series.describeSingleSeries;
                        var m = (b.options.accessibility || {}).exposeAsGroupOnly;
                        c.options3d && c.options3d.enabled && a ||
                ...
                defaultPointDescriptionFormatter: u,
                defaultSeriesDescriptionFormatter: v,
                getPointA11yTimeDescription: g,
                getPointXDescription: m,
                getPointValue: A,
                getPointValueDescription: B
            }
        });
    r(a, "modules/accessibility/utils/Announcer.js", [a["parts/Globals.js"], a["modules/accessibility/utils/DOMElementProvider.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, f, q) {
        ...
        q = function () {
            ...
            a.prototype.addAnnounceRegion = function (a) {
                var e = this.chart.renderTo, f = this.domElementProvider.createElement("div");
    ...
    r(a, "modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/components/SeriesComponent/SeriesDescriber.js"], a["modules/accessibility/utils/Announcer.js"], a["modules/accessibility/utils/EventProvider.js"]], function (a, f, q, l, n, e) {
        ...
        function p(b, c) {
            var a =
                (b || []).concat(c || []).reduce(function (b, c) {
                    b[c.name + c.index] = c;
                    return b
                }, {});
        ...
        var k = f.extend, d = f.defined, c = q.getChartTitle, b = l.defaultPointDescriptionFormatter,
            g = l.defaultSeriesDescriptionFormatter;
        f = function (b) {
            this.chart = b
        };
        k(f.prototype, {
            init: function () {
                var b = this.chart, c = b.options.accessibility.announceNewData.interruptUser ? "assertive" : "polite";
                this.lastAnnouncementTime = 0;
                this.dirty = {allSeries: {}};
                this.eventProvider = new e;
                this.announcer = new n(b,
                    c);
                ...
                var b = this, c = this.chart, d = this.eventProvider;
                ...
                d.addEvent(a.Series, "addPoint", function (c) {
            ...
            onSeriesUpdatedData: function (b) {
                ...
                this.chart.options.accessibility.announceNewData.enabled && (this.dirty.hasDirty = !0, this.dirty.allSeries[b.name + b.index] = b, this.dirty.newSeries = d(this.dirty.newSeries) ? void 0 : b)
            }, onPointAdded: function (b) {
                var c = b.series.chart;
                this.chart === c && c.options.accessibility.announceNewData.enabled && (this.dirty.newPoint =
                ...
                var d = this, g = this.chart.options.accessibility.announceNewData;
                if (g.enabled) {
                    var e = +new Date;
                    g = Math.max(0, g.minAnnounceInterval -
                        (e - this.lastAnnouncementTime));
                    b = p(this.queuedAnnouncement && this.queuedAnnouncement.series, b);
                    if (c = this.buildAnnouncementMessage(b, c, a)) this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer), this.queuedAnnouncement = {
                        ...
                        d && d.announcer && (d.lastAnnouncementTime = +new Date, d.announcer.announce(d.queuedAnnouncement.message), delete d.queuedAnnouncement, delete d.queuedAnnouncementTimer)
                                                   ...
                                                   e, k) {
                var m = this.chart, f = m.options.accessibility.announceNewData;
                if (f.announcementFormatter && (d = f.announcementFormatter(d, e, k), !1 !== d)) return d.length ? d : null;
                d = a.charts && 1 < a.charts.length ? "Multiple" : "Single";
                d = e ? "newSeriesAnnounce" + d : k ? "newPointAnnounce" + d : "newDataAnnounce";
                f = c(m);
                return m.langFormat("accessibility.announceNewData." + d, {
                    chartTitle: f,
                    seriesDesc: e ? g(e) : null,
    ...
    r(a, "modules/accessibility/components/SeriesComponent/forcedMarkers.js", [a["parts/Globals.js"],
        ...
        function h(a) {
            n(!0, a, {marker: {enabled: !0, states: {normal: {opacity: 0}}}})
        }

        var l = f.addEvent, n = f.merge;
        return function () {
            l(a.Series, "render", function () {
                var a = this.options, f = this.chart.options.accessibility.enabled,
                    p = !1 !== (this.options.accessibility && this.options.accessibility.enabled);
                var k = this.chart.options.accessibility;
                k = this.points.length < k.series.pointDescriptionEnabledThreshold || !1 === k.series.pointDescriptionEnabledThreshold;
                var d = this.chart.options.accessibility.keyboardNavigation.seriesNavigation;
                d = this.points.length < d.pointNavigationEnabledThreshold || !1 === d.pointNavigationEnabledThreshold;
                if (f && p && (k || d)) {
                    if (a.marker && !1 === a.marker.enabled && (this.a11yMarkersForced = !0, h(this.options)), this._hasPointMarkers && this.points && this.points.length) for (a = this.points, f = a.length; f--;) p = a[f].options, p.marker && (p.marker.enabled ? n(!0, p.marker, {states: {normal: {opacity: p.marker.states && p.marker.states.normal && p.marker.states.normal.opacity || 1}}}) : h(p))
                } else this.a11yMarkersForced && this.resetMarkerOptions &&
                (delete this.a11yMarkersForced, a = this.resetA11yMarkerOptions, n(!0, this.options, {
                    marker: {
                        enabled: a.enabled,
            ...
            l(a.Series, "afterSetOptions", function (a) {
    ...
    r(a, "modules/accessibility/components/SeriesComponent/SeriesComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js"],
        ...
        f = f.extend;
        var d = t.hideSeriesFromAT, c = p.describeSeries;
        a.SeriesAccessibilityDescriber = p;
        e();
        a = function () {
        };
        a.prototype = new q;
        f(a.prototype, {
            init: function () {
                ...
                this.chart.series.forEach(function (b) {
                    !1 !== (b.options.accessibility && b.options.accessibility.enabled) && b.visible ? c(b) : d(b)
                })
            }, getKeyboardNavigation: function () {
    ...
    r(a, "modules/accessibility/components/ZoomComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"],
        ...
        var h = f.extend, p = f.pick, k = n.unhideChartElementFromAT, d = e.setElAttrs, c = e.removeElement;
        a.Axis.prototype.panStep = function (b, c) {
            var a = c || 3;
            c = this.getExtremes();
            ...
            d = c.min + d;
            var g = a - d;
            0 > b && d < c.dataMin ? (d = c.dataMin, a = d + g) : 0 < b && a > c.dataMax && (a = c.dataMax, d = a - g);
        ...
        h(a.prototype, {
            init: function () {
                ...
                var b = this.chart;
                c(this.drillUpProxyGroup);
                c(this.resetZoomProxyGroup);
            ...
            }, recreateProxyButtonAndGroup: function (b, a, d, e) {
                c(this[d]);
                this[d] = this.addProxyGroup();
                this[a] = this.createProxyButton(b, this[d], {"aria-label": e, tabindex: -1})
            }, getMapZoomNavigation: function () {
                var b = this.keyCodes, c = this.chart, a = this;
                return new l(c, {
                ...
                var c = this.chart, a = c.mapNavButtons[0], d = c.mapNavButtons[1];
                a = 0 < b ? a : d;
                ...
                var d = this.keyCodes, g = this,
                    e = this.chart;
                return new l(e, {
                    keyCodeMap: [[[d.tab, d.up, d.down, d.left, d.right], function (b, c) {
                        return this.response[b === d.tab && c.shiftKey || b === d.left || b === d.up ? "prev" : "next"]
                    }], [[d.space, d.enter], function () {
                        var b = a(this, e);
                        return p(b, this.response.success)
                    }]], validate: function () {
                        return e[b] && e[b].box && g[c]
                    }, init: function () {
                        e.setFocusToElement(e[b].box, g[c])
                    }
                })
            }, getKeyboardNavigation: function () {
                return [this.simpleButtonNavigation("resetZoomButton", "resetZoomProxyButton", function (b, c) {
                    ...
                    "drillUpProxyButton", function (b, c) {
                        c.drillUp();
    ...
    r(a, "modules/accessibility/components/RangeSelectorComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, f, q, l, n, e) {
        f = f.extend;
        var h = n.unhideChartElementFromAT,
            p = e.setElAttrs;
        a.Chart.prototype.highlightRangeSelectorButton = function (a) {
            var d = this.rangeSelector.buttons, c = this.highlightedRangeSelectorItemIx;
            "undefined" !== typeof c && d[c] && d[c].setState(this.oldRangeSelectorItemState || 0);
        ...
        f(a.prototype, {
            onChartUpdate: function () {
                ...
                c && (c.buttons && c.buttons.length && c.buttons.forEach(function (b) {
                    h(a, b.element);
                    d.setRangeButtonAttrs(b)
                }), c.maxInput && c.minInput && ["minInput", "maxInput"].forEach(function (b, g) {
                    if (b = c[b]) h(a, b), d.setRangeInputAttrs(b, "accessibility.rangeSelector." + (g ? "max" : "min") + "InputLabel")
                }))
                ...
                p(a.element, {tabindex: -1, role: "button", "aria-label": d})
            }, setRangeInputAttrs: function (a,
                                             d) {
                var c = this.chart;
                p(a, {tabindex: -1, role: "textbox", "aria-label": c.langFormat(d, {chart: c})})
            }, getRangeSelectorButtonNavigation: function () {
                var a = this.chart, d = this.keyCodes, c = this;
                return new l(a, {
                    keyCodeMap: [[[d.left, d.right, d.up, d.down], function (b) {
                        return c.onButtonNavKbdArrowKey(this, b)
                ...
                var c = a.response, b = this.keyCodes, g = this.chart,
                    e = g.options.accessibility.keyboardNavigation.wrapAround;
                d = d === b.left || d === b.up ? -1 : 1;
                return g.highlightRangeSelectorButton(g.highlightedRangeSelectorItemIx + d) ? c.success : e ? (a.init(d), c.success) : c[0 < d ? "next" : "prev"]
                ...
                var a = this.chart, d = this.keyCodes, c = this;
                return new l(a, {
                    keyCodeMap: [[[d.tab, d.up, d.down], function (b, a) {
                        return c.onInputKbdMove(this, b === d.tab && a.shiftKey || b === d.up ? -1 : 1)
                    }]], validate: function () {
                ...
                var c = this.chart;
                a = a.response;
                var b = c.highlightedInputRangeIx += d;
                if (1 < b || 0 > b) return a[0 < d ? "next" : "prev"];
    ...
    r(a, "modules/accessibility/components/InfoRegionsComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/utils/Announcer.js"], a["modules/accessibility/components/AnnotationsA11y.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
        function (a, f, q, l, n, e, t) {
            ...
            var k = a.win.document, d = f.extend, c = f.format, b = f.pick, g = n.getAnnotationsInfoHTML,
                m = e.unhideChartElementFromAT, r = e.getChartTitle, A = e.getAxisDescription, B = t.addClass,
                u = t.setElAttrs, z = t.escapeStringForHTML, v = t.stripHTMLTagsFromString, C = t.getElement,
                E = t.visuallyHideElement;
            a.Chart.prototype.getTypeDescription = function (b) {
                var a = b[0], c = this.series && this.series[0] || {};
                c = {
            ...
            d(f.prototype, {
                init: function () {
                    ...
                    this.screenReaderSections = {
                        before: {
                            element: null, buildContent: function (a) {
                ...
                getLinkedDescriptionElement: function () {
                    ...
                    b && (b.setAttribute("aria-hidden", "true"), B(b, "highcharts-linked-description"))
                }, updateScreenReaderSection: function (b) {
                    var a = this.chart, c = this.screenReaderSections[b], d = c.buildContent(a),
                        g = c.element = c.element || this.createElement("div"),
                        e = g.firstChild || this.createElement("div");
                    this.setScreenReaderSectionAttribs(g, b);
                    e.innerHTML = d;
                    g.appendChild(e);
                    c.insertIntoDOM(g, a);
                    E(e);
                    ...
                    var c = this.chart,
                        d = c.langFormat("accessibility.screenReaderSection." + a + "RegionLabel", {chart: c});
                    u(b, {id: "highcharts-screen-reader-region-" + a + "-" + c.index, "aria-label": d});
                    b.style.position = "relative";
                    "all" === c.options.accessibility.landmarkVerbosity && d && b.setAttribute("role", "region")
                },
                defaultBeforeChartFormatter: function () {
                    var b, c = this.chart, d = c.options.accessibility.screenReaderSection.beforeChartFormat,
                        e = this.getAxesDescription(),
                        f = c.sonify && (null === (b = c.options.sonification) || void 0 === b ? void 0 : b.enabled);
                    b = "highcharts-a11y-sonify-data-btn-" + c.index;
                    var m = "hc-linkto-highcharts-data-table-" + c.index, p = g(c),
                        k = c.langFormat("accessibility.screenReaderSection.annotations.heading", {chart: c});
                    e = {
                        chartTitle: r(c),
                        ...
                        playAsSoundButton: f ? this.getSonifyButtonText(b) : "",
                        viewTableButton: c.getCSV ? this.getDataTableButtonText(m) : "",
                        annotationsTitle: p ? k : "",
                        annotationsList: p
                    };
                    c = a.i18nFormat(d, e, c);
                    this.dataTableButtonId = m;
                    this.sonifyButtonId = b;
                    return h(z(c)).replace(/<(\w+)[^>]*?>\s*<\/\1>/g, "")
                    ...
                    return h(z(b)).replace(/<(\w+)[^>]*?>\s*<\/\1>/g, "")
                }, getLinkedDescription: function () {
                    var b = this.linkedDescriptionElement;
                    return v(b && b.innerHTML || "")
                }, getLongdescText: function () {
                    var b = this.chart.options, a = b.caption;
                    a = a && a.text;
                    ...
                    var a =
                        this.chart;
                    a = a.langFormat("accessibility.table.viewAsDataTableButtonText", {chart: a, chartTitle: r(a)});
                    return '<a id="' + b + '">' + a + "</a>"
                }, getSonifyButtonText: function (b) {
                    var a, c = this.chart;
                    if (!1 === (null === (a = c.options.sonification) || void 0 === a ? void 0 : a.enabled)) return "";
                    a = c.langFormat("accessibility.sonification.playAsSoundButtonText", {chart: c, chartTitle: r(c)});
                    ...
                    var b =
                        this.chart, a = b.langFormat("accessibility.screenReaderSection.endOfChartMarker", {chart: b});
                    return '<div id="highcharts-end-of-chart-marker-' + b.index + '">' + a + "</div>"
                }, onDataTableCreated: function (b) {
                    var a = this.chart;
                    a.options.accessibility.enabled && (this.viewDataTableButton && this.viewDataTableButton.setAttribute("aria-expanded", "true"), b.html = b.html.replace("<table ", '<table tabindex="0" summary="' + a.langFormat("accessibility.table.tableSummary", {chart: a}) + '"'))
                    ...
                    var a = this, c = this.sonifyButton = C(b), d = this.chart, g = function (b) {
                        ...
                        b.preventDefault();
                        b.stopPropagation();
                        b = d.langFormat("accessibility.sonification.playAsSoundClickAnnouncement", {chart: d});
                    ...
                    c && d && (u(c, {tabindex: "-1"}), c.onclick = function (b) {
                        var a;
                        ((null === (a = d.options.accessibility) || void 0 === a ? void 0 : a.screenReaderSection.onPlayAsSoundClick) || g).call(this, b, d)
                    })
                }, initDataTableButton: function (b) {
                    var a = this.viewDataTableButton = C(b), c = this.chart;
                    ...
                    a && (u(a, {
                        ...
                        "aria-expanded": !!C(b),
                        href: "#" + b
                    }), a.onclick = c.options.accessibility.screenReaderSection.onViewDataTableClick ||
                        function () {
                            c.viewData()
                        })
                }, getAxesDescription: function () {
                    var a = this.chart, c = function (c, d) {
                            c = a[c];
                            return 1 < c.length || c[0] && b(c[0].options.accessibility && c[0].options.accessibility.enabled, d)
                        }, d = !!a.types && 0 > a.types.indexOf("map"), g = !!a.hasCartesianSeries,
                        e = c("xAxis", !a.angular && g && d);
                    c = c("yAxis", g && d);
                    d = {};
                    ...
                    var a = this, c = this.chart, d = c[b];
                    return c.langFormat("accessibility.axis." +
                        b + "Description" + (1 < d.length ? "Plural" : "Singular"), {
                        chart: c,
                    ...
                    var g = c[d].toFixed("Seconds" !== d && "Minutes" !== d ? 1 : 0);
                    return a.langFormat("accessibility.axis.timeRange" + d, {
                        chart: a, axis: b, range: g.replace(".0",
                            "")
                    })
                }, getAxisFromToDescription: function (b) {
                    var a = this.chart, c = a.options.accessibility.screenReaderSection.axisRangeDateFormat,
                        d = function (d) {
    ...
    r(a, "modules/accessibility/components/ContainerComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"],
        ...
        a = f.extend;
        var h = q.stripHTMLTagsFromString, p = l.unhideChartElementFromAT, k = l.getChartTitle;
        q = function () {
        };
        q.prototype = new n;
        a(q.prototype, {
            ...
            handleSVGTitleElement: function () {
                var a = this.chart, c = "highcharts-title-" + a.index,
                    b = h(a.langFormat("accessibility.svgContainerTitle", {chartTitle: k(a)}));
                if (b.length) {
                ...
                var a = this.chart, c = h(a.langFormat("accessibility.svgContainerLabel", {chartTitle: k(a)}));
                a.renderer.box && c.length && a.renderer.box.setAttribute("aria-label",
                    c)
            }, setGraphicContainerAttrs: function () {
                var a = this.chart, c = a.langFormat("accessibility.graphicContainerLabel", {chartTitle: k(a)});
                c.length && a.container.setAttribute("aria-label", c)
                ...
                var a =
                    this.chart, c = a.credits;
                c && (c.textStr && c.element.setAttribute("aria-label", h(a.langFormat("accessibility.credits", {creditsStr: c.textStr}))), p(a, c.element))
            }, destroy: function () {
    ...
    r(a, "modules/accessibility/high-contrast-mode.js", [a["parts/Globals.js"]], function (a) {
        var f = a.isMS, h = a.win, l = h.document;
        return {
            isHighContrastModeActive: function () {
                var a = /(Edg)/.test(h.navigator.userAgent);
                if (h.matchMedia && a) return h.matchMedia("(-ms-high-contrast: active)").matches;
                if (f && h.getComputedStyle) {
                    a = l.createElement("div");
                    a.style.backgroundImage = "url(#)";
                    l.body.appendChild(a);
                    var e = (a.currentStyle || h.getComputedStyle(a)).backgroundImage;
    ...
    r(a, "modules/accessibility/high-contrast-theme.js", [], function () {
        return {
            ...
            rangeSelector: {
                ...
                }, inputBoxBorderColor: "windowText", inputStyle: {
                    backgroundColor: "window",
                    color: "windowText"
    ...
    r(a, "modules/accessibility/options/deprecatedOptions.js", [a["parts/Utilities.js"]], function (a) {
        function f(a, c, b) {
            p("Highcharts: Deprecated option " + c + " used. This will be removed from future versions of Highcharts. Use " + b + " instead.", !1, a)
        }
        ...
        function l(a, c, b, g) {
            ...
            var e = d(a.options, c), p = d(a.options, b);
            Object.keys(g).forEach(function (d) {
                var m = e[d];
                "undefined" !== typeof m && (h(p, g[d], m), f(a, c.join(".") + "." + d, b.join(".") + "." + g[d].join(".")))
            })
        }

        function n(a) {
            var c = a.options.chart || {}, b = a.options.accessibility || {};
            ["description", "typeDescription"].forEach(function (d) {
                c[d] && (b[d] = c[d], f(a, "chart." + d, "accessibility." + d))
            })
        }
        ...
        function t(a) {
            ...
            a.series.forEach(function (b) {
                Object.keys(c).forEach(function (d) {
                    var e =
                        b.options[d];
                    "undefined" !== typeof e && (h(b.options, c[d], "skipKeyboardNavigation" === d ? !e : e), f(a, "series." + d, "series." + c[d].join(".")))
                })
            })
        }

        var p = a.error, k = a.pick;
        return function (a) {
            n(a);
            e(a);
            a.series && t(a);
    ...
    r(a, "modules/accessibility/a11y-i18n.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, f) {
        function h(a, f) {
            var e = a.indexOf("#each("), h = a.indexOf("#plural("), d = a.indexOf("["), c = a.indexOf("]");
            if (-1 < e) {
                d = a.slice(e).indexOf(")") +
                    e;
                var b = a.substring(0, e);
                h = a.substring(d + 1);
                d = a.substring(e + 6, d).split(",");
                e = Number(d[1]);
                a = "";
                if (f = f[d[0]]) for (e = isNaN(e) ? f.length : e, e = 0 > e ? f.length + e : Math.min(e, f.length), d = 0; d < e; ++d) a += b + f[d] + h;
                return a.length ? a : ""
            }
            if (-1 < h) {
                b = a.slice(h).indexOf(")") + h;
                a = a.substring(h + 8, b).split(",");
                switch (Number(f[a[0]])) {
                    case 0:
                        a = n(a[4], a[1]);
                        break;
        ...
        var l = f.format, n = f.pick;
        a.i18nFormat = function (a, f, p) {
            var e = function (a, b) {
                a = a.slice(b || 0);
            ...
            do {
                var b = e(a, c);
                var g = a.substring(c, b && b.begin - 1);
                g.length && d.push({value: g, type: "constant"});
                b && d.push({value: b.statement, type: "statement"});
                c = b ? b.end + 1 : c + 1
            } while (b);
            d.forEach(function (a) {
                "statement" === a.type && (a.value = h(a.value, f))
            });
            return l(d.reduce(function (a, b) {
                return a + b.value
            }, ""), f, p)
        };
        a.Chart.prototype.langFormat = function (e, f) {
            e = e.split(".");
            for (var h = this.options.lang, k = 0; k < e.length; ++k) h = h && h[e[k]];
            return "string" === typeof h ? a.i18nFormat(h, f, this) : ""
        }
    });
    r(a, "modules/accessibility/focusBorder.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, f) {
        function h(a) {
            if (!a.focusBorderDestroyHook) {
                ...
                a.destroy = function () {
                    var b, d;
                    null === (d = null === (b = a.focusBorder) || void 0 === b ? void 0 : b.destroy) || void 0 === d ? void 0 : d.call(b);
        ...
        function l(a) {
            ...
            a.focusBorderUpdateHooks || (a.focusBorderUpdateHooks = {}, k.forEach(function (b) {
                b += "Setter";
        ...
        function n(a) {
            ...
            (Object.keys(a.focusBorderUpdateHooks).forEach(function (c) {
                var b = a.focusBorderUpdateHooks[c];
                b === a._defaultSetter ? delete a[c] : a[c] = b
            }), delete a.focusBorderUpdateHooks)
        }

        var e = f.addEvent, r = f.extend, p = f.pick, k = "x y transform width height r d stroke-width".split(" ");
        r(a.SVGElement.prototype, {
            addFocusBorder: function (d, c) {
                this.focusBorder && this.removeFocusBorder();
                var b = this.getBBox(), e = p(d, 3);
                b.x += this.translateX ? this.translateX : 0;
                b.y += this.translateY ? this.translateY : 0;
                var f = b.x - e, k = b.y - e, n = b.width + 2 *
                    e, q = b.height + 2 * e;
                if ("text" === this.element.nodeName || this.isLabel) {
                    var r = !!this.rotation;
                    if (this.isLabel) var t = {
                        x: r ? 1 : 0,
                        y: 0
                    }; else f = t = 0, "middle" === this.attr("text-anchor") ? (t = a.isFirefox && this.rotation ? .25 : .5, f = a.isFirefox && !this.rotation ? .75 : .5) : this.rotation ? t = .25 : f = .75, t = {
                        x: t,
                        y: f
                    };
                    f = +this.attr("x") - b.width * t.x - e;
                    k = +this.attr("y") - b.height * t.y - e;
                    this.isLabel && r && (r = n, n = q, q = r, f = +this.attr("x") - b.height * t.x - e, k = +this.attr("y") - b.width * t.y - e)
                }
                this.focusBorder = this.renderer.rect(f, k, n, q, parseInt((c &&
                    c.borderRadius || 0).toString(), 10)).addClass("highcharts-focus-border").attr({zIndex: 99}).add(this.parentGroup);
        ...
        a.Chart.prototype.renderFocusBorder = function () {
            var a =
                this.focusElement, c = this.options.accessibility.keyboardNavigation.focusBorder;
            a && (a.removeFocusBorder(), c.enabled && a.addFocusBorder(c.margin, {
        ...
        a.Chart.prototype.setFocusToElement = function (a, c) {
            ...
            (c = c || a.element) && c.focus && (c.hcEvents && c.hcEvents.focusin || e(c, "focusin", function () {
            }), c.focus(), b.hideBrowserFocusOutline && (c.style.outline = "none"));
            this.focusElement &&
    ...
    r(a, "modules/accessibility/accessibility.js", [a["modules/accessibility/utils/chartUtilities.js"], a["parts/Globals.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["parts/Point.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigation.js"], a["modules/accessibility/components/LegendComponent.js"], a["modules/accessibility/components/MenuComponent.js"],
        ...
        var t = n.addEvent, x = n.extend, w = n.fireEvent, D = n.merge, y = f.win.document;
        D(!0, f.defaultOptions, B, {accessibility: {highContrastTheme: A}, lang: u});
        f.A11yChartUtilities = a;
        f.KeyboardNavigationHandler = q;
        f.AccessibilityComponent = e;
        h.prototype = {
            init: function (a) {
                this.chart = a;
                y.addEventListener && a.renderer.isSVG ? (z(a), this.initComponents(), this.keyboardNavigation = new r(a, this.components),
                    this.update()) : a.renderTo.setAttribute("aria-hidden", !0)
            }, initComponents: function () {
                var a = this.chart, e = a.options.accessibility;
                this.components = {
                    container: new m,
                    infoRegions: new g,
                    legend: new p,
                ...
                !b.highContrastModeActive && v.isHighContrastModeActive() && v.setHighContrastTheme(b);
        ...
        f.Chart.prototype.updateA11yEnabled = function () {
            var a =
                this.accessibility, b = this.options.accessibility;
            b && b.enabled ? a ? a.update() : this.accessibility = new h(this) : a ? (a.destroy && a.destroy(), delete this.accessibility) : this.renderTo.setAttribute("aria-hidden", !0)
        };
        t(f.Chart, "render", function (a) {
        ...
        t(f.Chart, "update", function (a) {
            if (a = a.options.accessibility) a.customComponents &&
            (this.options.accessibility.customComponents = a.customComponents, delete a.customComponents), D(!0, this.options.accessibility, a), this.accessibility && this.accessibility.destroy && (this.accessibility.destroy(), delete this.accessibility);
            this.a11yDirty = !0
        });
        t(l, "update", function () {
