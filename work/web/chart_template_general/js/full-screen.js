...
(function (a) {
    ...
    function c(a, g, c, f) {
        a.hasOwnProperty(g) || (a[g] = f.apply(null, c))
    }

    a = a ? a._modules : {};
    c(a, "modules/full-screen.src.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, c) {
        var d = c.addEvent;
        c = a.Chart;
        var f =
            function () {
                ...
                a.prototype.setButtonText = function () {
                    var a, c = this.chart, d = c.exportDivElements, e = c.options.exporting,
                        f = null === (a = null === e || void 0 ===
                        e ? void 0 : e.buttons) || void 0 === a ? void 0 : a.contextButton.menuItems;
                    a = c.options.lang;
                    (null === e || void 0 === e ? 0 : e.menuItemDefinitions) && (null === a || void 0 === a ? 0 : a.exitFullscreen) && a.viewFullscreen && f && d && d.length && (d[f.indexOf("viewFullscreen")].innerHTML = this.isOpen ? a.exitFullscreen : e.menuItemDefinitions.viewFullscreen.text || a.viewFullscreen)
                };
        ...
        a.Fullscreen = f;
        d(c, "beforeRender", function () {
            this.fullscreen = new a.Fullscreen(this)
        });
        return a.Fullscreen
    });
