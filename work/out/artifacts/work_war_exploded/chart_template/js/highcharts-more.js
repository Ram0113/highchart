...
(function (c) {
    ...
    B(c, "parts-more/Pane.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (l, a) {
        ...
        var b = a.addEvent, r = a.extend, t = a.merge, y = a.pick, c = a.splat, x = l.CenteredSeriesMixin;
        ...
        a = function () {
            ...
            g.prototype.setOptions = function (g) {
                this.options = t(this.defaultOptions, this.chart.angular ? {background: {}} : void 0, g)
            };
            g.prototype.render = function () {
                var g = this.options, b = this.options.background, a = this.chart.renderer;
                this.group || (this.group = a.g("pane-group").attr({zIndex: g.zIndex || 0}).add());
                this.updateCenter();
                if (b) for (b = c(b), g = Math.max(b.length, this.background.length || 0), a = 0; a < g; a++) b[a] && this.axis ? this.renderBackground(t(this.defaultBackgroundOptions, b[a]), a) : this.background[a] && (this.background[a] = this.background[a].destroy(), this.background.splice(a, 1))
            };
            g.prototype.renderBackground = function (g, b) {
                var a = "animate", k = {"class": "highcharts-pane " + (g.className || "")};
                ...
                this.background[b][a]({d: this.axis.getPlotBandPath(g.from, g.to, g)}).attr(k)
            };
        ...
        l.Chart.prototype.getHoverPane =
            function (g) {
                ...
                g && b.pane.forEach(function (m) {
                    var k = g.chartX - b.plotLeft, u = g.chartY - b.plotTop;
    ...
    B(c, "parts-more/RadialAxis.js", [c["parts/Axis.js"], c["parts/Tick.js"], c["parts-more/HiddenAxis.js"], c["parts/Utilities.js"]], function (l, a, d, b) {
        var r = b.addEvent, t = b.correctFloat, y = b.defined, c = b.extend, x = b.fireEvent, g = b.merge, u = b.pick,
            m = b.pInt, C = b.relativeLength, k = b.wrap;
        b = function () {
            function b() {
            }
            ...
            b.init = function (b) {
                ...
                b.getLinePath = function (e, h, f) {
                    e = this.pane.center;
                    var p = this.chart, w = u(h, e[2] / 2 - this.offset);
                    ...
                    this.isCircular || "undefined" !== typeof h ? (h = this.chart.renderer.symbols.arc(this.left + e[0], this.top + e[1], w, w, {
                        start: this.startAngleRad, end: this.endAngleRad, open: !0,
                        innerR: 0
                ...
                b.postTranslate = function (e, h) {
                    var f = this.chart, p = this.center;
                    e = this.startAngleRad + e;
                    return {x: f.plotLeft + p[0] + Math.cos(e) * h, y: f.plotTop + p[1] + Math.sin(e) * h}
                };
                b.getPlotBandPath =
                    function (e, h, f) {
                        var p = this.center, w = this.startAngleRad, v = p[2] / 2,
                            n = [u(f.outerRadius, "100%"), f.innerRadius, u(f.thickness, 10)],
                            g = Math.min(this.offset, 0), b = /%$/;
                        var a = this.isCircular;
                        if ("polygon" === this.options.gridLineInterpolation) n = this.getPlotLinePath({value: e}).concat(this.getPlotLinePath({
                            value: h,
                            reverse: !0
                        })); else {
                            ...
                            if ("circle" !== f.shape && a) e =
                                w + this.translate(e), h = w + this.translate(h); else {
                                e = -Math.PI / 2;
                                h = 1.5 * Math.PI;
                                var k = !0
                            }
                ...
                b.getCrosshairPosition = function (e, h,
                                                   f) {
                    var p = e.value, w = this.pane.center;
                    if (this.isCircular) {
                ...
                b.getPlotLinePath =
                    function (e) {
                        var h = this, f = h.pane.center, p = h.chart, w = p.inverted, v = e.value, n = e.reverse,
                            g = h.getPosition(v),
                            b = h.pane.options.background ? h.pane.options.background[0] || h.pane.options.background : {},
                            a = b.innerRadius || "0%", k = b.outerRadius || "100%";
                        b = f[0] + p.plotLeft;
                        var m = f[1] + p.plotTop, q = g.x, d = g.y, u = h.height;
                        g = f[3] / 2;
                        var A;
                        ...
                        if (h.isCircular) v = Math.sqrt(Math.pow(q - b, 2) + Math.pow(d - m, 2)), n = "string" === typeof a ? C(a, 1) : a / v, p = "string" === typeof k ?
                            C(k, 1) : k / v, f && g && (v = g / v, n < v && (n = v), p < v && (p = v)), f = [["M", b + n * (q - b), m - n * (m - d)], ["L", q - (1 - p) * (q - b), d + (1 - p) * (m - d)]]; else if ((v = h.translate(v)) && (0 > v || v > u) && (v = 0), "circle" === h.options.gridLineInterpolation) f = h.getLinePath(0, v, g); else if (f = [], p[w ? "yAxis" : "xAxis"].forEach(function (f) {
                            f.pane === h.pane && (A = f)
                        }), A) for (b = A.tickPositions, A.autoConnect && (b = b.concat([b[0]])), n && (b = b.slice().reverse()), v && (v += g), q = 0; q < b.length; q++) m = A.getPosition(b[q], v), f.push(q ? ["L", m.x, m.y] : ["M", m.x, m.y]);
                        return f
                    };
                b.getTitlePosition =
                    function () {
                        var e = this.center, h = this.chart, f = this.options.title;
                        return {
                            x: h.plotLeft + e[0] + (f.x || 0),
                            y: h.plotTop + e[1] - {high: .5, middle: .25, low: 0}[f.align] * e[2] + (f.y || 0)
                        }
                    };
            ...
            b.compose = function (a, m) {
                r(a, "init", function (e) {
                    var h = this.chart, f = h.inverted, p = h.angular, w = h.polar,
                        v = this.isXAxis, n = this.coll, E = p && v, k, m = h.options;
                    ...
                    if ("colorAxis" === n) this.isRadial = !1; else {
                        ...
                        p || w ? (this.isRadial =
                            !0, m.chart.zoomType = null, this.labelCollector || (this.labelCollector = this.createLabelCollector()), this.labelCollector && h.labelCollectors.push(this.labelCollector)) : this.isRadial = !1;
                        e && k && (e.axis = this);
                        this.isCircular = k
                    }
                });
                r(a, "afterInit", function () {
                    var e = this.chart, h = this.options, f = this.pane, p = f && f.options;
                ...
                r(m, "afterGetLabelPosition", function (e) {
                    var h = this.axis, f = this.label;
                    if (f) {
                        var p = f.getBBox(),
                            w = h.options.labels, b = w.y, n = 20, g = w.align,
                            a = (h.translate(this.pos) + h.startAngleRad + Math.PI / 2) / Math.PI * 180 % 360,
                            k = Math.round(a), m = "end", q = 0 > k ? k + 360 : k, d = q, A = 0, r = 0,
                            t = null === w.y ? .3 * -p.height : 0;
                        if (h.isRadial) {
                            var l = h.getPosition(this.pos, h.center[2] / 2 + C(u(w.distance, -25), h.center[2] / 2, -h.center[2] / 2));
                            "auto" === w.rotation ? f.attr({rotation: a}) : null === b && (b = h.chart.renderer.fontMetrics(f.styles && f.styles.fontSize).b - p.height / 2);
                            null === g && (h.isCircular ? (p.width > h.len * h.tickInterval / (h.max - h.min) && (n = 0), g = a > n &&
                            a < 180 - n ? "left" : a > 180 + n && a < 360 - n ? "right" : "center") : g = "center", f.attr({align: g}));
            ...
            b.defaultRadialOptions = {
                gridLineInterpolation: "circle", gridLineWidth: 1,
    ...
    B(c, "parts-more/AreaRangeSeries.js", [c["parts/Globals.js"], c["parts/Point.js"], c["parts/Utilities.js"]], function (l, a, d) {
        var b = d.defined, r = d.extend, t = d.isArray, y = d.isNumber, c = d.pick;
        d = d.seriesType;
        var x = l.seriesTypes, g = l.Series.prototype, u = a.prototype;
        d("arearange", "area", {
            lineWidth: 1,
            threshold: null,
            ...
            pointArrayMap: ["low", "high"], pointValKey: "low", deferTranslatePolar: !0, toYData: function (g) {
                return [g.low, g.high]
            }, highToXY: function (g) {
                var b = this.chart, a = this.xAxis.postTranslate(g.rectPlotX, this.yAxis.len - g.plotHigh);
                g.plotHighX = a.x - b.plotLeft;
                g.plotHigh = a.y - b.plotTop;
                g.plotLowX = g.plotX
            }, translate: function () {
                var g = this, b = g.yAxis, a = !!g.modifyValue;
                ...
                var b = [], a = [], d, m = x.area.prototype.getGraphPath;
                var q = this.options;
                var e = this.chart.polar && !1 !== q.connectEnds, h = q.connectNulls, f = q.step;
                g = g || this.points;
                for (d = g.length; d--;) {
                    var p = g[d];
                    p.isNull || e || h || g[d + 1] &&
                    !g[d + 1].isNull || a.push({plotX: p.plotX, plotY: p.plotY, doCurve: !1});
                    var w = {
                ...
                g = m.call(this, g);
                f && (!0 === f && (f = "left"), q.step = {left: "right", center: "center", right: "left"}[f]);
                b = m.call(this, b);
                a = m.call(this, a);
                q.step = f;
                q = [].concat(g, b);
                ...
                var b = this.points, a = b.length, k, d = [], u = this.options.dataLabels, q, e = this.chart.inverted;
                if (t(u)) if (1 < u.length) {
                    var h = u[0];
                    var f = u[1]
                } else h = u[0], f = {enabled: !1}; else h = r({}, u), h.x = u.xHigh, h.y = u.yHigh, f = r({}, u), f.x = u.xLow, f.y = u.yLow;
                if (h.enabled || this._hasPointLabels) {
                    ...
                    for (k = a; k--;) if (q = b[k]) q.dataLabelUpper = q.dataLabel, q.dataLabel = d[k], delete q.dataLabels, q.y = q.low, q.plotY = q._plotY
                }
                if (f.enabled || this._hasPointLabels) {
                    for (k = a; k--;) if (q = b[k]) p = f.inside ? q.plotHigh < q.plotLow : q.plotHigh > q.plotLow,
                        q.below = !p, e ? f.align || (f.align = p ? "left" : "right") : f.verticalAlign || (f.verticalAlign = p ? "bottom" : "top");
                    this.options.dataLabels = f;
                    g.drawDataLabels && g.drawDataLabels.apply(this, arguments)
                }
                if (h.enabled) for (k = a; k--;) if (q = b[k]) q.dataLabels = [q.dataLabelUpper, q.dataLabel].filter(function (f) {
                    return !!f
                });
            ...
            setState: function () {
                var g = this.state, a = this.series, d = a.chart.polar;
                ...
                var g = this.series.chart.polar, b = [];
                this.plotY = this.plotLow;
    ...
    B(c, "parts-more/AreaSplineRangeSeries.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (l, a) {
        a = a.seriesType;
        a("areasplinerange", "arearange", null, {getPointSpline: l.seriesTypes.spline.prototype.getPointSpline});
        ""
    });
    B(c, "parts-more/ColumnRangeSeries.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (l, a) {
        var d = a.clamp, b = a.merge, r = a.pick;
        a = a.seriesType;
        var t = l.defaultPlotOptions, y = l.noop, c = l.seriesTypes.column.prototype;
        a("columnrange", "arearange", b(t.column, t.arearange, {
            ...
            translate: function () {
                var b = this, g = b.yAxis, a = b.xAxis, m = a.startAngleRad,
                    t, k = b.chart, l = b.xAxis.isRadial, A = Math.max(k.chartWidth, k.chartHeight) + 999, q;
                c.translate.apply(b);
                b.points.forEach(function (e) {
                    var h = e.shapeArgs, f = b.options.minPointLength;
                    ...
                    h.x - h.width / 2, w] : [a.left - k.plotLeft + h.x + h.width / 2, g.pos - k.plotTop + p + w / 2, w])
                })
            },
            directTouch: !0,
    ...
    B(c, "parts-more/ColumnPyramidSeries.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (l, a) {
        var d = a.clamp, b = a.pick;
        a = a.seriesType;
        var r = l.seriesTypes.column.prototype;
        a("columnpyramid", "column", {}, {
            translate: function () {
                var a =
                    this, l = a.chart, c = a.options, x = a.dense = 2 > a.closestPointRange * a.xAxis.transA;
                x = a.borderWidth = b(c.borderWidth, x ? 0 : 1);
                var g = a.yAxis, u = c.threshold, m = a.translatedThreshold = g.getThreshold(u),
                    C = b(c.minPointLength, 5), k = a.getColumnMetrics(), z = k.width,
                    A = a.barW = Math.max(z, 1 + 2 * x), q = a.pointXOffset = k.offset;
                l.inverted && (m -= .5);
                c.pointPadding && (A = Math.ceil(A));
                r.translate.apply(a);
                a.points.forEach(function (e) {
                    var h = b(e.yBottom, m), f = 999 + Math.abs(h), p = d(e.plotY, -f, g.len + f);
                    f = e.plotX + q;
                    var w = A / 2, v = Math.min(p, h);
                    h = Math.max(p,
                        h) - v;
                    var n;
                    e.barX = f;
    ...
    B(c, "parts-more/GaugeSeries.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (l, a) {
        var d = a.clamp, b = a.isNumber, r = a.merge, t = a.pick, c = a.pInt;
        a = a.seriesType;
        var D = l.Series, x = l.TrackerMixin;
        a("gauge", "line", {
            dataLabels: {
                borderColor: "#cccccc",
                borderRadius: 3,
            ...
            trackerGroups: ["group", "dataLabelsGroup"],
            translate: function () {
                var g = this.yAxis, a = this.options, m = g.center;
                this.generatePoints();
                this.points.forEach(function (u) {
                    var k = r(a.dial, u.dial), l = c(t(k.radius, "80%")) * m[2] / 200,
                        A = c(t(k.baseLength, "70%")) * l / 100, q = c(t(k.rearLength, "10%")) * l / 100,
                        e = k.baseWidth || 3, h = k.topWidth || 1, f = a.overshoot,
            ...
            drawPoints: function () {
                var g = this, b = g.chart, a = g.yAxis.center, d = g.pivot, k = g.options, l = k.pivot, A = b.renderer;
                g.points.forEach(function (a) {
                    var e = a.graphic, h = a.shapeArgs, f = h.d, p = r(k.dial, a.dial);
                ...
                d ? d.animate({
                    translateX: a[0],
                    translateY: a[1]
                }) : (g.pivot = A.circle(0, 0, t(l.radius, 5)).attr({zIndex: 2}).addClass("highcharts-pivot").translate(a[0], a[1]).add(g.group), b.styledMode || g.pivot.attr({
            ...
            animate: function (a) {
                ...
                a || b.points.forEach(function (a) {
                    var g = a.graphic;
                    g && (g.attr({rotation: 180 * b.yAxis.startAngleRad / Math.PI}), g.animate({rotation: a.shapeArgs.rotation}, b.options.animation))
                })
            },
            render: function () {
    ...
    B(c, "parts-more/BoxPlotSeries.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (l, a) {
        ...
        a("boxplot", "column", {
            ...
            pointArrayMap: ["low", "q1", "median", "q3", "high"], toYData: function (a) {
                ...
                return {}
            }, drawDataLabels: b, translate: function () {
                ...
                var a =
                        this, b = a.options, r = a.chart, l = r.renderer, g, u, m, c, k, z, A = 0, q, e, h, f,
                    p = !1 !== a.doQuartiles, w, v = a.options.whiskerLength;
                a.points.forEach(function (n) {
                    var E = n.graphic, I = E ? "animate" : "attr", L = n.shapeArgs, H = {}, J = {}, t = {}, K = {},
                        G = n.color || a.color;
                    ...
                    v && (n.whiskers = l.path().addClass("highcharts-boxplot-whisker").add(E)), p && (n.box = l.path(void 0).addClass("highcharts-boxplot-box").add(E)), n.medianShape = l.path(void 0).addClass("highcharts-boxplot-median").add(E)), r.styledMode || (J.stroke = n.stemColor || b.stemColor || G, J["stroke-width"] = d(n.stemWidth, b.stemWidth, b.lineWidth), J.dashstyle = n.stemDashStyle || b.stemDashStyle || b.dashStyle, n.stem.attr(J), v && (t.stroke = n.whiskerColor || b.whiskerColor || G, t["stroke-width"] = d(n.whiskerWidth, b.whiskerWidth, b.lineWidth),
                        ...
                        A, g], ["L", A, c]], n.stem[I]({d: E}), p && (z = n.box.strokeWidth() % 2 / 2, g = Math.floor(g) + z, u = Math.floor(u) + z, e += z, h += z, E = [["M", e, u], ["L", e, g], ["L", h, g], ["L", h, u], ["L", e, u], ["Z"]], n.box[I]({d: E})), v && (z = n.whiskers.strokeWidth() % 2 / 2, m += z, c += z, w = /%$/.test(v) ? f * parseFloat(v) / 100 : v / 2, E = [["M", A - w, m], ["L", A + w, m], ["M", A - w, c], ["L", A + w, c]], n.whiskers[I]({d: E})), k = Math.round(n.medianPlot), z = n.medianShape.strokeWidth() % 2 / 2, k += z, E = [["M", e, k], ["L", h, k]], n.medianShape[I]({d: E}))
                })
            }, setStackedPoints: b
        });
        ""
    });
    B(c, "parts-more/ErrorBarSeries.js",
        [c["parts/Globals.js"], c["parts/Utilities.js"]], function (l, a) {
            a = a.seriesType;
            var d = l.noop, b = l.seriesTypes;
            a("errorbar", "boxplot", {
                color: "#000000",
                grouping: !1,
                linkedTo: ":previous",
                ...
                type: "errorbar", pointArrayMap: ["low", "high"], toYData: function (b) {
                    return [b.low, b.high]
                }, pointValKey: "high", doQuartiles: !1, drawDataLabels: b.arearange ? function () {
                    var a = this.pointValKey;
                    b.arearange.prototype.drawDataLabels.call(this);
                    this.data.forEach(function (b) {
                        b.y = b[a]
                    })
                } : d, getColumnMetrics: function () {
    ...
    B(c, "parts-more/WaterfallSeries.js", [c["parts/Globals.js"], c["parts/Point.js"], c["parts/Utilities.js"], c["parts/Stacking.js"]], function (l, a, d, b) {
        var r = d.addEvent, c = d.arrayMax, y = d.arrayMin, D = d.correctFloat, x = d.isNumber, g = d.objectEach,
            u = d.pick;
        d = d.seriesType;
        var m = l.Axis,
            C = l.Chart, k = l.Series, z = l.seriesTypes;
        ...
        m.prototype.renderWaterfallStackTotals = function () {
            var a = this.waterfallStacks, d = this.stacking && this.stacking.stackTotalGroup,
        ...
        d("waterfall", "column", {
            ...
            },
            {
                pointValKey: "y", showLine: !0, generatePoints: function () {
                    ...
                    var b = this.options, a = this.yAxis, e, h = u(b.minPointLength, 5), f = h / 2, p = b.threshold,
                        g = b.stacking, v = a.waterfallStacks[this.stackKey];
                    ...
                    var b = this.options, e = this.yData, h = b.data, f = e.length, p = b.threshold || 0, g, v, n, d, m;
                    ...
                    var a = this.data, b = this.yAxis, e = a.length, h = Math.round(this.graph.strokeWidth()) % 2 / 2,
                        f = Math.round(this.borderWidth) % 2 / 2, p = this.xAxis.reversed, g = this.yAxis.reversed,
                        v = this.options.stacking, n = [], d;
                    for (d = 1; d < e; d++) {
                        var k = a[d].shapeArgs;
                        var m = a[d - 1];
                    ...
                    function a(f, h, a, b) {
                        if (x) for (a; a < x; a++) t.stackState[a] += b; else t.stackState[0] = f, x = t.stackState.length;
                        t.stackState.push(t.stackState[x - 1] + h)
                    }

                    var b = this.options, e = this.yAxis.waterfallStacks, h = b.threshold, f = h || 0, p = f,
                        g = this.stackKey, v = this.xData, n = v.length, d, k, m;
                    ...
                    if (a) {
                        ...
                        return {dataMin: y(e), dataMax: c(h)}
                    }
    ...
    B(c, "parts-more/PolygonSeries.js", [c["parts/Globals.js"], c["mixins/legend-symbol.js"], c["parts/Utilities.js"]], function (c, a, d) {
        d = d.seriesType;
        var b = c.Series, r = c.seriesTypes;
        d("polygon", "scatter", {
            ...
            }, drawLegendSymbol: a.drawRectangle, drawTracker: b.prototype.drawTracker, setStackedPoints: c.noop
        });
        ""
    });
    B(c, "parts-more/BubbleLegend.js", [c["parts/Globals.js"], c["parts/Color.js"], c["parts/Legend.js"], c["parts/Utilities.js"]], function (c, a, d, b) {
        ...
        var r = a.parse;
        a = b.addEvent;
        var l = b.arrayMax, y = b.arrayMin, D = b.isNumber, x = b.merge, g = b.objectEach, u = b.pick, m = b.stableSort,
            C = b.wrap, k = c.Series, z = c.Chart, A = c.noop, q = c.setOptions;
        q({
            legend: {
                bubbleLegend: {
                    borderColor: void 0,
        ...
        q = function () {
            ...
            a.prototype.drawLegendSymbol =
                function (a) {
                    var f = this.chart, h = this.options, b = u(a.options.itemDistance, 20), e = h.ranges;
            ...
            a.prototype.setOptions = function () {
                var a = this.ranges, f = this.options, b = this.chart.series[f.seriesIndex], e = this.legend.baseline,
                    g = {"z-index": f.zIndex, "stroke-width": f.borderWidth},
                    n = {"z-index": f.zIndex, "stroke-width": f.connectorWidth}, d = this.getLabelStyles(),
                    k = b.options.marker.fillOpacity, c = this.chart.styledMode;
                a.forEach(function (h, p) {
                    ...
                    a[p] = x(a[p], {center: a[0].radius - a[p].radius + e});
                    c || x(!0, a[p], {bubbleStyle: x(!1, g), connectorStyle: x(!1, n), labelStyle: d})
                }, this)
            };
            a.prototype.getLabelStyles = function () {
                var a = this.options, f = {}, b = "left" === a.labels.align, e = this.legend.options.rtl;
                g(a.labels.style, function (a, b) {
                    "color" !== b && "fontSize" !== b && "z-index" !== b && (f[b] = a)
                });
                return x(!1, f, {
                    "font-size": a.labels.style.fontSize, fill: u(a.labels.style.color,
                        "#000000"), "z-index": a.zIndex, align: e || b ? "right" : "left"
                })
            };
            ...
            a.prototype.render = function () {
                var a = this.chart.renderer, f = this.options.zThreshold;
            ...
            a.prototype.renderRange = function (a) {
                var f = this.options, b = f.labels, e = this.chart.renderer, h = this.symbols, g = h.labels,
                    d = a.center, k = Math.abs(a.radius), c = f.connectorDistance || 0, m = b.align,
                    r = b.style.fontSize;
                c = this.legend.options.rtl || "left" === m ? -c : c;
                b = f.connectorWidth;
                var l = this.ranges[0].radius ||
                    0, u = d - k - f.borderWidth / 2 + b / 2;
                ...
                h.connectors.push(e.path(e.crispLine([["M", l, u], ["L", l + c, u]], f.connectorWidth)).attr(t ? {} :
            ...
            a.prototype.getRanges = function () {
                var a =
                    this.legend.bubbleLegend, f = a.options.ranges, b, e = Number.MAX_VALUE, g = -Number.MAX_VALUE;
                ...
                var n = e === g ? [{value: g}] : [{value: e}, {value: (e + g) / 2}, {value: g, autoRanges: !0}];
            ...
            a.prototype.predictBubbleSizes = function () {
                var a = this.chart, f = this.fontMetrics, b = a.legend.options, e = "horizontal" === b.layout,
                    g = e ? a.legend.lastLineHeight : 0, n = a.plotSizeX, d = a.plotSizeY,
            ...
            a.prototype.correctSizes = function () {
                var a = this.legend, f = this.chart.series[this.options.seriesIndex];
        ...
        a(d, "afterGetAllItems", function (a) {
            var b = this.bubbleLegend, f = this.options, e = f.bubbleLegend,
        ...
        d.prototype.getLinesHeights = function () {
            var a = this.allItems, b = [], f = a.length, g, d = 0;
            for (g = 0; g < f; g++) if (a[g].legendItemHeight && (a[g].itemHeight =
        ...
        d.prototype.retranslateItems = function (a) {
            var b, f, e, g = this.options.rtl, d = 0;
            this.allItems.forEach(function (h, p) {
                b = h.legendGroup.translateX;
                f = h._legendItemPos[1];
                if ((e = h.movementX) || g && h.ranges) e = g ? b - h.options.maxSize / 2 : b + e, h.legendGroup.attr({translateX: e});
                p > a[d].step && d++;
                h.legendGroup.attr({
        ...
        a(k, "legendItemClick", function () {
            var a = this.chart, b = this.visible, f = this.chart.legend;
            f && f.bubbleLegend && (this.visible = !b, this.ignoreSeries = b, a = 0 <= a.getVisibleBubbleSeriesIndex(), f.bubbleLegend.visible !== a && (f.update({bubbleLegend: {enabled: a}}), f.bubbleLegend.visible = a), this.visible = b)
        });
        C(z.prototype, "drawChartBox", function (a, b, f) {
            var e = this.legend, h = 0 <= this.getVisibleBubbleSeriesIndex();
    ...
    B(c, "parts-more/BubbleSeries.js", [c["parts/Globals.js"], c["parts/Color.js"], c["parts/Point.js"], c["parts/Utilities.js"]], function (c, a, d, b) {
        var r = a.parse, l = b.arrayMax, y = b.arrayMin, D = b.clamp, x = b.extend, g = b.isNumber, u = b.pick,
            m = b.pInt;
        a = b.seriesType;
        b = c.Axis;
        var C = c.noop, k = c.Series, z = c.seriesTypes;
        a("bubble", "scatter", {
            dataLabels: {
                formatter: function () {
                    return this.point.z
            ...
            getRadii: function (a, b, e) {
                var g = this.zData, f = this.yData, p = e.minPxSize, d = e.maxPxSize, v = [];
                var n = 0;
            ...
            getRadius: function (a, b, e, h, f, p) {
                var d = this.options, v = "width" !== d.sizeBy, n = d.zThreshold, k = b - a, c = .5;
            ...
            animate: function (a) {
                !a && this.points.length < this.options.animationLimit && this.points.forEach(function (a) {
                    var b = a.graphic;
                    if (b && b.width) {
                        var g = {x: b.x, y: b.y, width: b.width, height: b.height};
        ...
        b.prototype.beforePadding =
            function () {
                var a = this, b = this.len, e = this.chart, h = 0, f = b, p = this.isXAxis, d = p ? "xData" : "yData",
                    k = this.min, n = {}, c = Math.min(e.plotWidth, e.plotHeight), r = Number.MAX_VALUE,
                    t = -Number.MAX_VALUE, C = this.max - k, x = b / C, z = [];
                ...
                z.forEach(function (b) {
                    var e = b[d], n = e.length;
                    p && b.getRadii(r, t, b);
                    if (0 < C) for (; n--;) if (g(e[n]) && a.dataMin <= e[n] && e[n] <= a.max) {
        ...
        c.networkgraphIntegrations = {
            verlet: {
                attractiveForceFunction: function (a, d) {
                    ...
                    var c = a.getMass(), l = -b.x * d * this.diffTemperature;
                    ...
                    var b = -a.options.friction, c = a.options.maxSpeed, l = (d.plotX + d.dispX - d.prevX) * b;
                    b *= d.plotY + d.dispY - d.prevY;
                    var y = Math.abs, D = y(l) / (l || 1);
                    y = y(b) / (b || 1);
                    ...
                    d.plotX += l;
                    d.plotY += b;
                    d.temperature = a.vectorLength({x: l, y: b})
                }, getK: function (a) {
                ...
                attractiveForceFunction: function (a, d) {
                    ...
                    var b = d.temperature = a.vectorLength({x: d.dispX, y: d.dispY});
    ...
    B(c, "modules/networkgraph/QuadTree.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (c, a) {
        ...
        a(d.prototype, {
            insert: function (a, c) {
                ...
                var a =
                    this.box.width / 2, c = this.box.height / 2;
                this.nodes[0] = new d({left: this.box.left, top: this.box.top, width: a, height: c});
                this.nodes[1] = new d({left: this.box.left + a, top: this.box.top, width: a, height: c});
        ...
        c = c.QuadTree = function (a,
                                   c, l, y) {
            this.box = {left: a, top: c, width: l, height: y};
            this.maxDepth = 25;
    ...
    B(c, "modules/networkgraph/layouts.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (c, a) {
        var d = a.addEvent, b = a.clamp, l = a.defined, t = a.extend, y = a.isFunction, D = a.pick, x = a.setAnimation;
        a = c.Chart;
        c.layouts = {
        ...
        t(c.layouts["reingold-fruchterman"].prototype, {
            init: function (a) {
                ...
                this.simulation && c.win.cancelAnimationFrame(this.simulation)
                                  ...
                                  b, d, c) {
                this.box = {left: a, top: b, width: d, height: c}
            }, setK: function () {
            ...
            initPositions: function () {
                ...
                var b = this.box, d = this.nodes, c = 2 * Math.PI / (d.length + 1), k = d.filter(function (a) {
                        return 0 === a.linksTo.length
                    }),
                    l = [], r = {}, q = this.options.initialPositionRadius;
                ...
                var b = this.box, d = this.nodes, c = d.length + 1;
                ...
                return this.barycenter = {x: b, y: d, xFactor: b / a, yFactor: d / a}
            }, barnesHutApproximation: function (a, b) {
                var g = this.getDistXY(a, b), d = this.vectorLength(g);
                if (a !== b && 0 !==
                    d) if (b.isInternal) if (b.boxSize / d < this.options.theta && 0 !== d) {
                    var c = this.repulsiveForce(d, this.k);
                    this.force("repulsive", a, c * b.mass, g, d);
                    var l = !1
                } else l = !0; else c = this.repulsiveForce(d, this.k), this.force("repulsive", a, c * b.mass, g, d);
                return l
        ...
        c.dragNodesMixin = {
            onMouseDown: function (a,
                ...
                if (a.fixedPosition && a.inDragMode) {
                    var b = this.chart, c = b.pointer.normalize(d);
    ...
    B(c, "parts-more/PackedBubbleSeries.js", [c["parts/Globals.js"], c["parts/Color.js"],
        c["parts/Point.js"], c["parts/Utilities.js"]], function (c, a, d, b) {
        var l = a.parse, t = b.addEvent, y = b.clamp, D = b.defined, x = b.extend;
        a = b.extendClass;
        var g = b.fireEvent, u = b.isArray, m = b.isNumber, C = b.merge, k = b.pick;
        b = b.seriesType;
        var z = c.Series, A = c.Chart, q = c.layouts["reingold-fruchterman"],
            e = c.seriesTypes.bubble.prototype.pointClass, h = c.dragNodesMixin;
        c.networkgraphIntegrations.packedbubble = {
            repulsiveForceFunction: function (a, b, e, c) {
                ...
                var a =
                    this, b = a.options.gravitationalConstant, e = a.box, c = a.nodes, h, d;
                ...
                c.fixedPosition || (c.plotX -= b, c.plotY -=
                    e)
            }, integrate: c.networkgraphIntegrations.verlet.integrate, getK: c.noop
        };
        c.layouts.packedbubble = a(q, {
            beforeStep: function () {
                ...
                var a = this, b = a.box, e = a.nodes, c = 2 * Math.PI / (e.length + 1), h, d,
                ...
                var a = this, b, e, c, h = a.options.bubblePadding;
        ...
        b("packedbubble", "bubble", {
            ...
            accumulateAllPoints: function (a) {
                var f = a.chart, b = [], e, c;
                for (e = 0; e < f.series.length; e++) if (a =
                    f.series[e], a.visible || !f.options.chart.ignoreHiddenSeries) for (c = 0; c < a.yData.length; c++) b.push([null, null, a.yData[c], a.index, c, {
                    id: c,
                    marker: {radius: 0}
                }]);
                return b
            ...
            seriesBox: function () {
                var a = this.chart, b = Math.max, e = Math.min, c, d = [a.plotLeft, a.plotLeft +
            ...
            drawGraph: function () {
                if (this.layout && this.layout.options.splitSeries) {
                    ...
                    this.parentNodesGroup || (this.parentNodesGroup = this.plotGroup("parentNodesGroup", "parentNode", e,
                        .1, a.seriesGroup), this.group.attr({zIndex: 2}));
            ...
            createParentNodes: function () {
                var a = this, b = a.chart, c = a.parentNodeLayout, d, h = a.parentNode;
                a.parentNodeMass = 0;
            ...
            addSeriesLayout: function () {
                var a = this.options.layoutAlgorithm, b = this.chart.graphLayoutsStorage,
                    ...
                    d = C(a, a.parentNodeOptions, {enableSimulation: this.layout.options.enableSimulation});
            ...
            addLayout: function () {
                var a = this.options.layoutAlgorithm, b = this.chart.graphLayoutsStorage,
                    e = this.chart.graphLayoutsLookup, d =
            ...
            translate: function () {
                var a = this.chart, b = this.data, e = this.index, c, h = this.options.useSimulation;
                ...
                for (c = 0; c < d.length; c++) if (d[c][3] === e) {
                    var k = b[d[c][4]];
                    var l = d[c][2];
                    h || (k.plotX = d[c][0] - a.plotLeft + a.diffX, k.plotY = d[c][1] - a.plotTop + a.diffY);
                    k.marker = x(k.marker, {radius: l, width: 2 * l, height: 2 * l});
                    k.radius = l
                }
                h && this.deferLayout();
            ...
            checkOverlap: function (a, b) {
                var f = a[0] - b[0], e = a[1] - b[1];
                return -.001 > Math.sqrt(f * f + e * e) - Math.abs(a[2] + b[2])
            },
            positionBubble: function (a, b, e) {
                var f = Math.sqrt, c = Math.asin, d = Math.acos, h = Math.pow, g = Math.abs;
            ...
            placeBubbles: function (a) {
                var b = this.checkOverlap, f = this.positionBubble, e = [], c = 1, d = 0, h = 0;
                var g = [];
                var k;
                ...
                if (a.length) {
                    ...
                    if (1 < a.length) for (e.push([[0, 0 - a[1][2] - a[0][2], a[1][2], a[1][3], a[1][4]]]), k = 2; k < a.length; k++) a[k][2] = a[k][2] || 1, g = f(e[c][d], e[c - 1][h], a[k]), b(g, e[c][0]) ? (e.push([]),
            ...
            resizeRadius: function () {
                var a = this.chart, b = a.rawPositions, e = Math.min, c = Math.max, d = a.plotLeft, h = a.plotTop,
                    g = a.plotHeight, k = a.plotWidth, l, m, q;
            ...
            calculateZExtremes: function () {
                var a = this.options.zMin, b = this.options.zMax, e = Infinity, c = -Infinity;
                if (a && b) return [a, b];
                this.chart.series.forEach(function (a) {
            ...
            getPointRadius: function () {
                var a = this, b = a.chart, e = a.options, c = e.useSimulation, d = Math.min(b.plotWidth, b.plotHeight),
                    h = {}, g = [], k = b.allDataPoints, l, m, q, r;
                ["minSize", "maxSize"].forEach(function (a) {
                    var b = parseInt(e[a], 10), f = /%$/.test(e[a]);
            ...
            onMouseUp: function (a) {
                if (a.fixedPosition && !a.removed) {
                    var b, e, c = this.layout, f = this.parentNodeLayout;
    ...
    B(c, "parts-more/Polar.js", [c["parts/Globals.js"], c["parts/Utilities.js"], c["parts-more/Pane.js"]], function (c, a, d) {
        var b = a.addEvent, l = a.animObject, t = a.defined, y = a.find, D = a.isNumber, x = a.pick, g = a.splat,
            u = a.uniqueKey, m = a.wrap, C = c.Series, k = c.seriesTypes, z = C.prototype, A = c.Pointer.prototype;
        z.searchPointByAngle =
            function (a) {
                var b = this.chart, e = this.xAxis.pane.center;
        ...
        z.getConnectors = function (a, b, c, d) {
            ...
            e = {rightContX: k, rightContY: l, leftContX: g, leftContY: h, plotX: e, plotY: f};
            c && (e.prevPointCont = this.getConnectors(a, b, !1, d));
            return e
        };
        z.toXY = function (a) {
            var b = this.chart, e = this.xAxis;
            var c = this.yAxis;
            var d = a.plotX, g = a.plotY, k = a.series, l = b.inverted, m =
                a.y, q = l ? d : c.len - g;
        ...
        b(C, "afterTranslate", function () {
            ...
            if (a.polar && this.xAxis) {
                ...
                if (!this.preventPostTranslate) for (var d = this.points,
        ...
        m(z, "getGraphPath",
            function (a, b) {
                ...
                if (this.chart.polar) {
                    b = b || this.points;
                    for (c = 0; c < b.length; c++) if (!b[c].isNull) {
                        var d = c;
                        break
                    }
        ...
        var q = function (a, b) {
            var e = this, d = this.chart, h = this.options.animation, g = this.group, k = this.markerGroup,
                m = this.xAxis.center, q = d.plotLeft, r =
                    d.plotTop, t, u, z, y;
            if (d.polar) if (e.isRadialBar) b || (e.startAngleRad = x(e.translatedThreshold, e.xAxis.startAngleRad), c.seriesTypes.pie.prototype.animate.call(e, b)); else {
                if (d.renderer.isSVG) if (h = l(h), e.is("column")) {
                    if (!b) {
                        ...
                        e.points.forEach(function (a) {
                            ...
                            z = (u = a.shapeArgs) && u.r;
                            y = u && u.innerR;
                            t && u && (t.attr({r: A, innerR: A}), t.animate({r: z, innerR: y}, e.options.animation))
                        })
                    }
                } else b ? (a = {
                    translateX: m[0] + q,
        ...
        k.column && (C = k.arearange.prototype, k = k.column.prototype, k.polarArc = function (a, b, c, d) {
            ...
            if (g.isRadial) {
                ...
                for (; g--;) {
                    ...
                    if (d.inverted) {
                        ...
                        F > B && (B = [F, F = B][0]);
                        if (!l) if (F < u) F = u; else if (B > z) B = z; else {
                            if (B < u || F > z) F = B = 0
                        ...
                        c.shapeArgs = {x: m && m[0], y: m && m[1], r: C, innerR: A, start: F, end: B};
            ...
            function (a, b, c, d, g, k) {
                var e = this.chart, f = x(d.inside, !!this.options.stacking);
        ...
        c.SVGRenderer.prototype.clipCircle = function (a, b, c, d) {
            var e = u(), f = this.createElement("clipPath").attr({id: e}).add(this.defs);
