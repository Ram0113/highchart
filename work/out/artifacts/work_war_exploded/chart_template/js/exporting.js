...
(function (g) {
    ...
    n(g, "modules/full-screen.src.js", [g["parts/Globals.js"], g["parts/Utilities.js"]], function (e, f) {
        ...
        var l = function () {
            ...
            e.prototype.setButtonText = function () {
                var e, f = this.chart, g = f.exportDivElements, l = f.options.exporting,
    ...
    n(g, "modules/exporting.src.js", [g["parts/Globals.js"], g["parts/Utilities.js"], g["mixins/navigation.js"]], function (e, f, g) {
        var l = f.addEvent, q = f.css, k = f.createElement, n = f.discardElement,
            w = f.extend, I = f.find, A = f.fireEvent, J = f.isObject, r = f.merge, E = f.objectEach, t = f.pick,
            K = f.removeEvent, L = f.uniqueKey, v = e.defaultOptions, x = e.doc, B = e.Chart, M = e.isTouchDevice,
            y = e.win, G = y.navigator.userAgent, F = e.SVGRenderer, H = e.Renderer.prototype.symbols,
        ...
        w(B.prototype, {
            sanitizeSVG: function (a, b) {
                ...
                w(c.chart, {animation: !1, renderTo: d, forExport: !0, renderer: "SVGRenderer", width: f, height: g});
                ...
                return this.getSVG(r({chart: {borderRadius: 0}}, c.chartOptions, b, {
                    exporting: {
                ...
                var a = x.body, b = this.options.exporting.printMaxWidth,
                ...
                var h = this, D = h.options.navigation, r = h.chartWidth, z = h.chartHeight, p = "cache-" + a, m = h[p],
                    C = Math.max(e, g);
                if (!m) {
                    h.exportContextMenu = h[p] = m = k("div", {className: a}, {
                        position: "absolute",
                        zIndex: 1E3,
                        padding: C + "px",
                        pointerEvents: "auto"
                    }, h.fixedDiv || h.container);
                    var n = k("ul", {className: "highcharts-menu"}, {listStyle: "none", margin: 0, padding: 0}, m);
                    h.styledMode || q(n, w({
                    ...
                    b.forEach(function (a) {
                        ...
                        if (J(a, !0)) {
                            if (a.separator) var b = k("hr", null, null, n); else b = k("li", {
                ...
                var b =
                        this, c = b.renderer, d = r(b.options.navigation.buttonOptions, a), e = d.onclick, f = d.menuItems,
                    g = d.symbolSize || 12;
                b.btnCount || (b.btnCount = 0);
                b.exportDivElements || (b.exportDivElements = [], b.exportSVGElements = []);
                if (!1 !== d.enabled) {
                    var h = d.theme, k = h.states, l = k && k.hover;
                    k = k && k.select;
                    var z;
                    ...
                    var p = c.button(d.text, 0, 0, z, h, l, k).addClass(a.className).attr({title: t(b.options.lang[d._titleKey || d.titleKey], "")});
                    p.menuClassName = a.menuClassName || "highcharts-menu-" + b.btnCount++;
                    if (d.symbol) {
                        var m = c.symbol(d.symbol, d.symbolX - g / 2, d.symbolY - g / 2,
                            g, g, {width: g, height: g}).addClass("highcharts-button-symbol").attr({zIndex: 1}).add(p);
                        b.styledMode || m.attr({
                    ...
                    p.add(b.exportingGroup).align(w(d, {width: p.width, x: t(d.x, b.buttonOffset)}), !0, "spacingBox");
                ...
                var c = b.exportDivElements, d = b.exportEvents, e;
        ...
        B.prototype.inlineStyles = function () {
            ...
            function b(c) {
                ...
                if (1 === c.nodeType && -1 === f.indexOf(c.nodeName)) {
                    ...
                    if (O || N) for (var x in u) p(u[x], x); else E(u, p);
